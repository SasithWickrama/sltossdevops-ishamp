...
<!--            <span style="font-family: Potha; font-size: 20px"><i>i-Shamp</i></span>-->
        ...
        <ul class="navbar-item flex-row nav-dropdowns">
            ...
            <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="media">
                        <?php   echo '<img class=\"flag-width\" src="../assets/img/user.png" style="border-radius: 50%; width:30px; height:30px"/>'; ?>
                        <div class="media-body align-self-center">
                            <h6><span>Welcome,</span> <?php echo $_SESSION['uname']?> - <?php echo $_SESSION["ucatagory"]?> </h6>
                        </div>
                    </div>
