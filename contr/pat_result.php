...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#pat-confirm').dataTable({
            ajax: 'dynamic_load.php?x=patsuccess&y=<?php echo $areas;?>&con=<?php echo $con;?>',
        ...
        $('#pat-reject').dataTable({
            ajax: 'dynamic_load.php?x=patreject&y=<?php echo $areas;?>&con=<?php echo $con;?>',
            dom: '<"row"<"col-md-12"<"row"<"col-md-6"B><"col-md-6"f> > ><"col-md-12"rt> <"col-md-12"<"row"<"col-md-5"i><"col-md-7"p>>> >',
            scrollX: true,
            buttons: {
                buttons: [
