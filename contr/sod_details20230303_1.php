...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true){
    ...
    if($stype == 'AB-CAB' || $stype == 'AB-FTTH') {
        ...
        if ($stat == 'INSTALL_CLOSED' || $stat == 'COMPLETED'){
...
<!--                                                        </select>-->
                                    ...
                                    <div class="row" style="font-size: 15px; font-weight: bold">
                                        <div class="col-lg-10 col-md-6 col-sm-8  mr-auto">
                                            <div class="form-check form-switch">

                                            <?php if($getSodImgupSt[0] != 'Y'){ ?>
                                            
                                                <input type="checkbox" role="switch" id="btnoffline" onclick="checkOffline()">
                                                <label style="color:#0dcaf0"> OFFLINE POTO UPLOAD</label>

                                            <?php }else{ ?>

                                            <label style="color:#f39c12">Image Upload Method: OFFLINE POTO UPLOAD</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 ">
                                                            ...
                                                            <select  class="form-control basic"  name="mobusr" id="mobusr" style="color:#1C96B1; font-weight: bold"  required>
                                                                ...
                                                                <?php
                                                                $getMobTeam = $db->getMobTeam($con);
                                                                foreach ($getMobTeam as $mobusr ){
                                                                    echo "<option value=\"$mobusr[0]\">$mobusr[0]</option>";
                                                                }
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <div class="row">
                                                                ...
                                                                if($stat == 'OSP_CLOSED' || $stat == 'INSTALL_CLOSED' || $stat == 'COMPLETED') {
                                                                    ...
                                                                    foreach ($getMobTeam as $mobusr) {
                                                                        if ($getSnAssign[11] == $mobusr[0]) {
                                                                            echo "<option value=\"$mobusr[0]\" selected>$mobusr[0]</option>";
                                                                        }
                                                                    }
                                                                }else{
                                                                    $getMobTeam = $db->getMobTeam($con);
                                                        ...
                                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 ">
                                                            ...
                                                            <?php }else{ ?>
                                                                <button class="btn btn-info" id="mobasgnButton" style="height: 40px;"  onclick="SnMobChange()">CHANGE</button>
                                                            <?php }?>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card-body ">
                                                ...
                                                foreach( $getAllImg as $row ) {
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-8  mr-auto">
                                                        ...
                                                        <input type="file" id="<?php echo $row[0].'img_file'; ?>" name="<?php echo $row[0].'img_file'; ?>" accept="image/*" <?php if($row[3] == 'S' || $row[3] == 'X'){ echo 'multiple'; }?>>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-10 col-md-12 col-sm-8  mr-auto center">
                                                        <button class="btn btn-sm btn-danger" onclick="deleteImg(<?php echo $row[0]; ?>);" title="Delete"><i class="fa fa-trash"></i></button>
                                                        </div>
        ...
        if ($('#btnoffline').is(':checked')) {
            ...
            if (result.isConfirmed) {
                ...
                success:function(data){
                    ...
                    document.getElementById("btnoffline").checked = false;
