        ...
        <div class="layout-px-spacing">
            ...
            <br/><div class="page-header">
                <div class="page-title">
                    <h4>MEGALINE -  FTTH - PEO TV DETAILS</h4>
...
<script>
    ...
    function getSods(){
        ...
        var dat = rtom+'_'+fromDate+'_'+toDate+'_'+stat+'_'+con
        if(rtom == ''){
            Snackbar.show({
                text: 'RTOM Required',
                actionTextColor: '#fff',
                ...
                columns: [{
                    ...
                    },
                    {
                        "render": function(data, type, row, meta) {
                            if (row['CON_STATUS']  == 'ASSIGNED'){
                            ...
                            else if (row['CON_STATUS']  == 'INPROGRESS'){
                            ...
                            else if (row['CON_STATUS']  == 'OSP_CLOSED'){
                                data = '<a style="color: #770337; " href="sod_details?sod=' + row['SO_NUM'] + '_OSPCLOSED_' + row['CON_WORO_SEIT'] + '_FTTH' +'" target="_blank">' + row['SO_NUM'] + '</a>';

                            }
                            else if (row['CON_STATUS']  == 'INSTALL_CLOSED' ){
                                ...
                                data = '<a style="color: #770337; " href="sod_details?sod=' + row['SO_NUM'] + '_COMPLETED_' + row['CON_WORO_SEIT'] + '_FTTH' +'" target="_blank">' + row['SO_NUM'] + '</a>';
                            }
                            return data;
                        }
