        ...
        <div class="layout-px-spacing">
            ...
            <div class="page-header">
                ...
                <?php if($row[24] == 'PAT_REJECTED'){ ?>
                    <button class="btn btn-success mb-4" style="height: 40px;"  onclick="patReCorrect()" >CORRECTED</button>
                <?php } ?>
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row" style="font-size: 15px; font-weight: bold">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-8">
                                        <div class="col-lg-12 col-md-12 col-sm-8  mr-auto center"><label style="color: #0dcaf0" title="<?php echo $row[4]; ?>"><?php echo $loadImg[0][2]; ?></label></div>
                                        <div class="col-lg-2 col-md-6 col-sm-8  mr-auto image-set">
                                            <a data-magnify="gallery" data-src="" data-group="a" title="<?php echo $loadImg[2]; ?>" href="<?php echo $img_url; ?>">
                                                <img class="modal2-content <?php if($loadImg[0][3] == 5){ echo 'rjborder';}  if($loadImg[0][3] == 10){ echo 'acptborder';} ?>" id="1" src="<?php echo $img_url; ?>" width="200" height="200" onerror="this.src='../assets/img/no-image.png'">
                                            </a>
                                        </div>
                                        <div class="col-lg-2 col-md-6 col-sm-8"  mr-auto center"><textarea style="color: #0dcaf0; height: 30px; width: 200px;"  disabled><?php echo $loadImg[0][1]; ?> </textarea></div>
