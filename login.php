...
<head>
    ...
    <title>i-Shamp - Login Page</title>
        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                        ...
                        <img src="assets/img/ishamp.PNG">


                    <form method="post" action="auth" class="text-left">
                        ...
                        <div class="form">
                            ...
                            <div id="password-field" class="field-wrapper input mb-2">
                                <div class="d-flex justify-content-between">
                                    <label for="password" style="font-size: small; font-weight: bold">PASSWORD</label>
                                </div>
                            ...
                            <p class="signup-link"> <a href="passwd">GET PASSWORD</a></p>
