    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            <br/><div class="page-header">
                ...
                <div class="page-title">
                    <button class="btn btn-info" id="assignButton" style="height: 35px;"  onclick="addUser()"><i class="fa fa-close"></i>ADD USER</button>
                </div>
                ...
                columns: [{
                    ...
                    },
                    {
                        "render": function (data, type, row, meta) {
                            return '<td><span style="padding-left: 25px;"></span><img src="../assets/img/edit.png" id="img1" data-toggle="tooltip" title="Confirm"  width="25" height="25" onclick="confirmval()"/></td>';

                        }
                    },
                    {
                        "render": function (data, type, row, meta) {
                            return '<td><span style="padding-left: 25px;"></span><img src="../assets/img/del.png" id="img1"  width="25" height="25" onclick="delval()"/></td>';
