            ...
            <div class="row layout-top-spacing">
                <div class="col-lg-12 col-12 layout-spacing" >
                    <div class="statbox widget box box-shadow">
                                    ...
                                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 col-12 ">
                                        ...
                                        <?php if ($getFtthDW[3] != '' ){ ?>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2 col-md-6 col-sm-8  mr-auto">
                                                    <input type="number"  id="dwvalue" class="form-control" style="border-radius:5px;width:150px;height:40px;  color:#1C96B1; font-weight: bold"  value="<?php echo $getFtthDW[3]; ?>" disabled>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 col-12 ">
                                <label style="color: #0dcaf0">PAT COMMENT</label><br/><br/>
                                <input type="text" class="form-control" id="patcomment">
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function patStat(stat){
        ...
        if (r == true) {
            ...
            info[0]="<?php echo $sod; ?>";
            info[1]=stat;
            info[2]=document.getElementById('patcomment').value;
