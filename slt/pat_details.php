                            ...
                            <div class="card-body ">
                                ...
                                <div class="widget-content widget-content-area border-top-tab">
                                    ...
                                    <div class="tab-content" id="borderTopContent">
                                        ...
                                        <input style="display:none;" type="text" id="status" value="<?php echo $status; ?>"/>
                                                    ...
                                                    if($rowimg[0] != ''){
                                                        ...
                                                        <div id = "<?php echo $rowimg[0].'rwaddcmt'; ?>">
                                                            <div class="col-lg-10 col-md-12 col-sm-8  mr-auto center">
                                                                ...
                                                                <?php if( ($status == 'PAT_OPMC_PASSED' || $status == 'OPMC_PAT_SKIP')  && $stg==1){ ?>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-8  mr-auto center" id="<?php echo $rowimg[0].'rwbtnvwcmt'; ?>">
                                                                ...
                                                                <a class="btn btn-sm btn-primary" target="_blank" href="../map/patImgmap.php?imgId=<?php echo $rowimg[0];?>&soid=<?php echo $sod;?>" title="View Map"><i class="fa fa-map"></i></a>
                                                                ...
                                                                <?php if($status == 'PAT_CORRECTED' && $stg==2){ ?>
                                                                    <button class="btn btn-sm btn-success" onclick="ImgAccept(<?php echo $rowimg[0] ?>);" title="Accept"><i class="fa fa-check"></i></button>
                                                                    <button class="btn btn-sm btn-danger" onclick="ImgReject(<?php echo $rowimg[0] ?>);" title="Reject"><i class="fa fa-close"></i></button>
                                                                    <button class="btn btn-sm btn-secondary" onclick="ImgCompare(<?php echo $rowimg[0] ?>);" title="Image Compare"><i class="fa fa-picture-o"></i></button>
                                                                <?php } ?>
...
<script>
    ...
    function savepatGenCmt(){

    var soId = $('#soId').val();
    var cmt = $('#'+soId+'cmt').val();
    ...
    type:"post",
    url:"../db/DbFunctions",
    data:{info:info,q:"addGenCmt"},
    success:function(data){

        if(data == "success"){

            Snackbar.show({
                text: 'Comment Save Success',
                actionTextColor: '#fff',
                backgroundColor: '#6ccb09',
                pos: 'top-center',
            });
    ...
    type:"post",
    url:"../db/DbFunctions",
    data:{info:info,q:"loadPatGenCmt"},
    success:function(data){
    ...
    $.ajax({
        type:"post",
        url:"../db/DbFunctions",
        data:{info:info,q:"imgCompare"},
        success:function(data){

            des += '<div class="row">'+
                        '<div class="col-md-6 text-center"><label style="color: #0dcaf0">Previous Image</label></div>'+
                        '<div class="col-md-6 text-center"><label style="color: #0dcaf0">New Image</label></div>'+
                    '</div>'+
                    '<div class="row">';
                    ...
                    $.each(data, function(key, data) {
                        ...
                        dirname = "https://serviceportal.slt.lk/ApiPro/ImageApi/uploads/"+data[0]+"/";

                        img_url = dirname+data[3]+'.png';
                        
                        $('.modal-title').html(data[2]);

                        des += '<div class="col-md-6">'+
                        '<a data-magnify="gallery" data-src="" data-group="a" title="'+data[2]+'" href="'+img_url+'">'+
                        '<img class="modal2-content ';
                        ...
                        des +='" width="500" height="500" src="'+img_url+'"/></a></div>';

                    });

                    des += '</div>';

                $('#img_frm_body').html(des);
...
<div id="imgModal" class="modal">
    <div class="modal-dialog" style="max-width: 1500px;">
        <div class="modal-content" style="max-width: 1500px;">
            <div class="modal-header">
                <h4 class="modal-title" style="color: #0dcaf0"></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                
            </div>
            <div class="modal-body" id="img_frm_body">
